    ...
    <div id="marketing-shop-list" class="grid-view" >
        <table class="items">
            ...
            <tbody>
                            ...
                            <td>1,730</td>
                            <td >
                                                                    <a title="商品一覧" href="/marketing/topItemList/195761"><img src="/images/icon/op-item.png" alt="" /></a>                                    <a title="広告解析" ><img id="intro-step-2" data-step="2" src="/images/icon/op-ad.png" alt="" /></a>                                                                                            </td>
