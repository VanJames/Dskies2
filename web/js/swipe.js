...
Swipe.prototype = {
    ...
    setup: function() {
        ...
        // dynamic css
        this.element.style.width = (this.slides.length * this.width - 600) + 'px';
    ...
    slide: function(index, duration) {
        ...
        style.MozTransform = style.webkitTransform = 'translate3d(' + -(index * this.width+590) + 'px,0,0)';
        style.msTransform = style.OTransform = 'translateX(' + -(index * this.width+590) + 'px)';
    ...
    next: function(delay) {
        ...
        if (this.index < this.length - 3) this.slide(this.index+1, this.speed); // if not last slide
