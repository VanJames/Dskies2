...
広告分析 &raquo; <a href="/marketing/list">ショップ一覧</a> &raquo; <span>レディース靴の店 shop kilakila</span></div>                        <div id="content" class="marketing clearfix">
                <!-- form -->
    ...
    <div class="clearfix">
        ...
        <div class="col-lg-4">
            ...
            <div class="input-group">
                ...
                <input type="hidden"  id="pop_msg"   value="既に<span class='red'>7</span>店舗が登録されており、<br/>残り<span class='red'>143</span>店舗を追加することができます。<br/>を広告分析に追加登録しますか？<br/>(追加後<span class='red'>30</span>日間は一覧から削除できません。)"/>
                <input type="text"
...
<p class="text-right button-group">
    <span class="pull-left">追加済みショップ(7/150)</span>
    ...
    <div id="marketing-shop-list" class="grid-view" >
        <table class="items">
            ...
            <tbody>
                            ...
                            <td>1,315</td>
                            <td >
                                                                    <a title="商品一覧"><img id="intro-step-2" data-step="2" src="/images/icon/op-item.png" alt="" /></a>                                    <a title="広告解析" href="/marketing/analysis/243900"><img src="/images/icon/op-ad.png" alt="" /></a>                                                                                            </td>
