...
<div id="chk-box">
    <div class="grid-view" id="marketing-shop-list">
        <table class="items">
            ...
            <tbody>
                                                                                    <tr class="even"  id="intro-step-1" data-step="1">
                            ...
                            <td>8</td>
                            <td>
                                                                    <a href="/marketing/topItemList/198199" title="商品一覧"><img alt="" src="/images/icon/op-item.png"></a>                                    <a href="/marketing/analysis/198199" title="広告解析"><img alt="" src="/images/icon/op-ad.png"></a>                                                                                            </td>
