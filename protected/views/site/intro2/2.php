...
広告分析 » <a href="/marketing/list">ショップ一覧</a> » <span>エメフィール</span></div>
    ...
    <div class="clearfix">
        ...
        <div class="col-lg-4">
            ...
            <div class="input-group">
                ...
                <input type="hidden" value="既に&lt;span class='red'&gt;10&lt;/span&gt;店舗が登録されており、&lt;br/&gt;残り&lt;span class='red'&gt;140&lt;/span&gt;店舗を追加することができます。&lt;br/&gt;を広告分析に追加登録しますか？&lt;br/&gt;(追加後&lt;span class='red'&gt;30&lt;/span&gt;日間は一覧から削除できません。)" id="pop_msg">
...
<p class="text-right button-group">
    <span class="pull-left">追加済みショップ(10/150)</span>
...
<div id="chk-box">
    <div class="grid-view" id="marketing-shop-list">
        <table class="items">
            ...
            <tbody>
                                                                                    <tr class="even">
                            <td><a href="http://www.rakuten.co.jp/sockkobe/" target="_blank">エメフィール</a></td>
                            <td><span class="color-blue">3.13</span></td>
                            <td>97,399</td>
                            <td>1,075</td>
                            <td>58</td>
                            <td>62</td>
                            ...
                            <td>8</td>
                            <td>
                                                                    <a href="/marketing/topItemList/198199" title="商品一覧"><img alt="" src="/images/icon/op-item.png"></a>                                    <a onclick="goToNext(event)" href="/marketing/analysis/198199" title="広告解析"><img id="intro-step-2" data-step="2" alt="" src="/images/icon/op-ad.png"></a>                                                                                            </td>
                            <td><input type="checkbox" name="myNoticeShop[]" title="" value="198199" class="chk-one">                            </td>
                        </tr>
                                                </tbody>
        </table>
                    <div class="pager">
